 ...
 * integer/number and enum values when leaving enum. Replaces the old sequence of
 * updateVar() calls that each read a stale snapshot and clobbered the type back
